...
import static com.axonivy.utils.rtffactory.Constants.DOT;
import static com.axonivy.utils.rtffactory.Constants.SLASH;
...
public class ExportFromCms {
	...
	public static java.io.File export(String cmsUri, String ext) throws IOException {
		var file = StringUtils.removeStart(cmsUri, SLASH) + DOT + ext;
